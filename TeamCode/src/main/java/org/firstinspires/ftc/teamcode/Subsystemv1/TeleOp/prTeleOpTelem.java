...
@TeleOp(name = "TeleOp 2P Telem", group = "Subsystem")
public class prTeleOpTelem extends OpMode {
    ...
    public void init() {
        ...
        prbot.telem.setGamepad1(gamepad1);
        prbot.telem.setGamepad2(gamepad2);
    ...
    public void loop() {
        ...
        prbot.telem.addAll();
        prbot.telem.addGamepad1();
        prbot.telem.addGamepad2();
        prbot.telem.update();
    }
}
