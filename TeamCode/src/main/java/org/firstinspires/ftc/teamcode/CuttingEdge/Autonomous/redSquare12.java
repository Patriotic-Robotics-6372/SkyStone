...
@Disabled
@Autonomous (name = "auto redSquare12")
public class redSquare12 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        prBot.leftPinch.setPower(-.8);
        prBot.rightPinch.setPower(.8);
        sleep(1500);
        encoder(-2.8, -.5, -.5, "base");
